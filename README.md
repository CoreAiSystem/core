...
> Core AI infrastructure engine for model serving and pipeline orchestration - part of the [CoreAiSystem](https://github.com/CoreAiSystem) open-source ecosystem.
...
This repository contains the `core` component, which handles the core runtime responsibilities for CoreAiSystem.
...
```bash
git clone https://github.com/CoreAiSystem/core
cd core
go mod download
```
